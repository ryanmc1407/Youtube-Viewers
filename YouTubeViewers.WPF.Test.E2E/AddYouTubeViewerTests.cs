    ...
    public class Tests
    {
        ...
        public void ShouldAddYouTubeViewer()
        {
            ...
            try
            {
                ...
                driver.FindElementByAccessibilityId("YouTubeViewerUsernameTextBox").SendKeys("Ryanmc1407");
                ...
                WindowsElement addedYouTubeViewerListingItem = driver.FindElementByAccessibilityId("Ryanmc1407_YouTubeViewerListingItem");
